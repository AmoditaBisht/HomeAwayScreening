...
public class ProductionCodeTest {
	...
	public void TestAddRecipients1() {
		...
		ArrayList<Message> failedMessages = ce.addRecipientToAllMessages(messages, user, recipient);
		assertEquals(failedMessages.size(), 2);
	}

	@Test
	// Negative testcase2 - User is same as recipient and user
	// have the permissions to modify recipients and user has addrecipient
	// allowed
	// Expected Result - All are successful messages and recipient should be
	// added
	public void TestAddRecipients2() {
		...
		ArrayList<Message> successfulMessages = ce.addRecipientToAllMessages(messages, user, recipient);
	...
	// Expected Result - It should not allow the user to modify and fail all the
	// messages
